...
ImproperCvffShift::ImproperCvffShift(LAMMPS *lmp) : Improper(lmp)
{
  writedata = 1;
}
...
ImproperCvffShift::~ImproperCvffShift()
{
  if (allocated) {
...
void ImproperCvffShift::compute(int eflag, int vflag)
{
